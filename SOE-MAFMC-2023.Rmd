...
The annual estimate for gray seal bycatch has declined since 2019, in part driven by declining gillnet landings, though this estimate is uncertain due to low observer coverage since 2019. The rolling mean confidence interval remains just below the threshold.
