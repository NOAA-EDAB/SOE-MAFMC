...
```{r total-landings, fig.cap = paste0("Total commercial seafood landings (black) and ",region," managed seafood landings (red)."), fig.width = 4, fig.asp = 0.45, fig.show='hide'}
...
![commercial landings test alt text](`r knitr::fig-chunk('total-landings', 'png')`)
