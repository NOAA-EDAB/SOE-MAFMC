...
flextable::flextable(a$t) |>
  ...
  flextable::colformat_num(na_str = "-") |>
  flextable::set_caption("Social vulnerability rankings (ranging from low = low vulnerability to high = high vulnerability) for Mid-Atlantic communities most engaged in commercial fishing, 2022. Blank spaces indicate no data available.") |>
  flextable::autofit() 
...
flextable::flextable(a$t) |>
  flextable::set_header_labels(personal_disruption_rank = "Personal Disruption",
                               ...
                               poverty_rank = "Poverty") |>
  flextable::colformat_num(na_str = "-") |>
  flextable::set_caption("Social vulnerability rankings (ranging from low = low vulnerability to high = high vulnerability) for Mid-Atlantic communities most engaged in recreational fishing, 2022. Blank spaces indicate no data available.") |>
  flextable::autofit() 
