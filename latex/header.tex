...
\AddEverypageHook{%
   \ifthenelse{\value{page}=3}%
     {\rhead{\includegraphics[width=40pt]{images/NOAA_logo.png} \\ \textsf{\emph{17 March 2020}}}
      \lhead{\textsf{\LARGE State of the Ecosystem 2020: Mid-Atlantic}}
      }%
     {\rhead{}
      \lhead{\textsf{\emph{State of the Ecosystem 2020: Mid-Atlantic}}}
     }
}
