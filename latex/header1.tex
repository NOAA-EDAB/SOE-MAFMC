...
\fancyheadinit{%
   \ifthenelse{\value{page}=4}%
      {\fancyhead[R]{\includegraphics[width=40pt]{images/NOAA_logo.png} \\ \textsf{\emph{March 11, 2024}}}
       \fancyhead[L]{\textsf{\LARGE State of the Ecosystem 2024: Mid-Atlantic}}
      }%
      {\fancyhead[R]{}
       \fancyhead[L]{\textsf{\emph{State of the Ecosystem 2024: Mid-Atlantic}}}
      }
}
