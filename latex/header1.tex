...
\fancyheadinit{%
   \ifthenelse{\value{page}=4}%
      {\fancyhead[R]{\includegraphics[width=40pt]{images/NOAA_logo.png} \\ \textsf{\emph{Feb 10, 2022}}}
       \fancyhead[L]{\textsf{\LARGE DRAFT State of the Ecosystem 2023: Mid-Atlantic}}
      }%
      {\fancyhead[R]{}
       \fancyhead[L]{\textsf{\emph{DRAFT State of the Ecosystem 2023: Mid-Atlantic}}}
      }
}
