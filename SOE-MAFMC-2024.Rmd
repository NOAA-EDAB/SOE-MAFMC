...
```{r rec-op, fig.cap = paste0("Recreational effort in the ",region,".")}
...
```{r rec-div, fig.cap = paste0("Recreational fleet effort diversity in the ",region,".")}
...
```{r commercial-div, fig.cap = paste0("Commercial fleet count and diversity in the ",region,"."), fig.asp=.9}
...
```{r commercial-div-species-div,  fig.cap = paste0("Species revenue diversity in the ",region,".")}
...
```{r recdat-div-catch, fig.cap = paste0("Diversity of recreational catch in the ",region,".")}
