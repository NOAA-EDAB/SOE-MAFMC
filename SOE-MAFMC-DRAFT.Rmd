...
```{r ocean-temp, fig.width = 5, fig.asp = .7, fig.cap = paste0("Ocean temperature trends in the ",region,". \\label{ocean-temp}"), warning=F}
...
```{r ocean-sal, fig.width = 5, fig.asp = .7, fig.cap = paste0("Ocean salinity trends in the ",region,". \\label{ocean-sal}"), warning=F}
