...
```{r rec-landings, fig.cap = "Total recreational seafood harvest. \\label{rec-landings}", fig.width = 6, fig.height = 3}
...
ggplot(data = landings_rec) +
  ...
  scale_x_continuous(breaks = seq(1995, 2015, by = 5), expand = c(0.01, 0.01)) +
  scale_color_manual(values = series.col, aesthetics = "color")+
  guides(color = FALSE) +
