...
The `r council_abbr` only manages a portion of the total commercial landings that occur in the `r epu_abbr` region. For example, blue crabs represent a substantial portion of category D (Benthivores) landings. Therefore in `r latest_landings_data`, `r council_abbr` managed species accounted for **inline percentage** or the Benthivore landings and **inline percentage** of the revenue generated from those landings in the `r epu_abbr`.
