...
```{r cold-pool, fig.cap="Seasonal cold pool indices: mean temperature within the cold pool, persistence, and spatial extent",  code=readLines("https://raw.githubusercontent.com/NOAA-EDAB/ecodata/master/chunk-scripts/LTL_MAB.Rmd-cold_pool.R"), fig.width=10, fig.asp=.35}
