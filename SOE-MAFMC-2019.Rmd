...
```{r docformat, fig.cap = "Document orientation.", fig.subcap= c('Key to figures.', 'The Northeast Large Marine Ecosystem.'), out.width = '.4\\linewidth', fig.show="hold", out.height='2in'}
