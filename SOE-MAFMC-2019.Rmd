...
```{r mab-larval-div, fig.cap = "Larval diversity indices from ECOMON surveys in the Mid-Atlantic."}
...
```{r long-term-sst, fig.width = 5, fig.asp = 0.55, fig.cap = "Long term SST"}
...
The regional ocean is warming, with increasing variability between the winter and other seasons. Surface and bottom temperature trends in the MAB averaged over all seasons have significantly increased since the early 1980s; seasonal temperatures have increased in spring, summer, and fall. The 2018 summer sea surface temperatures were the third highest on record in the Mid-Atlantic, however temperatures during the other seasons were near or slightly below average (Figs. \ref{fig:MAB-SST-insitu}, \ref{fig:MAB-bot-temp}).  

```{r MAB-SST-insitu, fig.width = 8, fig.height = 7, fig.cap = "MAB seasonal sea surface time series and 2018 spatial anomalies"}
...
```{r MAB-bot-temp, fig.width = 6, fig.asp = .55, fig.cap = "Bottom temperature MAB"}
...
```{r MAB-oi-zoo, fig.width=8, fig.cap = "MAB seasonal zooplankton abundance, key species."}
facet_names <- list(
...
```{r MAB-sli, fig.cap = "MAB Primary production ratio and small-large zooplankton index."}
