...
```{r MAB-recruitment, fig.cap = "Small fish per large fish biomass anomaly in the Mid-Atlantic Bight. The summed anomaly across species is shown by the black line.",fig.width = 8, fig.height = 5}
...
The regional ocean is warming, with increasing variability between the winter and other seasons. Surface and bottom temperature trends in the MAB averaged over all seasons have significantly increased since the early 1980s, and seasonal temperatures have increased in spring, summer, and fall. The 2018 summer sea surface temperatures were the third highest on record in the Mid-Atlantic, although temperatures during the other seasons were near or slightly below average (Figs. \ref{fig:MAB-SST-insitu}, \ref{fig:MAB-bot-temp}).  
