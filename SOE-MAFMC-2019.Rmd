...
Each section begins with a summary of main messages with links to other sections, including any new information added at the request of the Council, and includes figures with brief descriptions of all current indicators. Technical methods documentation^[https://noaa-edab.github.io/tech-memo], and indicator data^[https://www.integratedecosystemassessment.noaa.gov/regions/northeast/Indicator-data#MidAtlanticIndicators] are available online.
