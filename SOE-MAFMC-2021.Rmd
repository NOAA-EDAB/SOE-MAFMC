...
Increased temp, increased rate of photosynthesis in all three EPUs in summer
Climatology of seasonal size fractions confirms that summer production dominated by smaller size classes (pico and nano)
Increased overall primary production from summer production
...
Driven by warming?
Related to fish condition? 

Forage anomaly from zooplankton data, no apparent trend in MA
Forage energy density
Lower now for herring than in 80s-90s
Zooplankton available
Kjoules per gram wet weight
Seasonal is only for recent years, change plot. Spring and fall for each species, species specific plots
...
### Implications
Surfclam more sensitive than sea scallops
Surfclam threshold metabolic depression in a pH range of 7.46-7.28
pH hasn't reached the threshold observed for surfclams in lab studies so far--BUT we haven’t yet tested thresholds for other species or for multiple life stages, specifically larval stages that are typically more vulnerable to OA.
Only one season of data (mostly 2019)
...
The decrease of pH decreases the feeding rates

Include Chesapeake info here too (warmer winter) and make connections inshore--offshore and add ideas about mechanisms
