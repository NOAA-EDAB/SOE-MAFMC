...
- Stocks are shifting distribution throughout the Northeast US Large Marine Ecosystem (Fig. \ref{fig:spec-dist}).  
```{r spec-dist, code = readLines("https://raw.githubusercontent.com/NOAA-EDAB/ecodata/master/chunk-scripts/macrofauna_MAB.Rmd-species-dist.R"), fig.asp=1}
```  
