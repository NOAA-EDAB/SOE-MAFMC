...
A marine heatwave is a warming event that lasts for five or more days with sea surface temperatures above the 90th percentile of the  historical daily climatology (1982-2011) [@hobday_hierarchical_2016]. The MAB experienced frequent ocean heatwaves of moderate intensity in 2020 that extended well into December, as also observed in Chesapeake Bay (Fig. \ref{fig:heatwave-year}).
