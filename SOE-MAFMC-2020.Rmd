...
d<-ecodata::energy_density #%>% 
    ...
    #        "Mean ED" = "Mean.ED" )
kable(d, booktabs = T, linesep = "", escape = FALSE,
      col.names = c("Species", "ED (SD)", "N", "ED (SD)", "N",
                    "ED (SD)", "N","ED (SD)", "N",
                    "ED (SD)", "N","ED", "ED (SD)"),
      caption = "Forage fish mean energy density (ED) mean and standard deviation (SD) by season and year. N = number sampled.") %>% 
  kable_styling(latex_options = c("hold_position", "scale_down")) %>% 
  add_header_above(c(" " = 1, "Spring" = 2, "Fall" = 2, "Spring" = 2, "Fall" = 2, " " = 4)) %>% 
  add_header_above(c(" " = 1, "2017" = 4, "2018" = 4, "Total" = 2, "Steimle and\\n Terranove (1985)" = 1, "Lawson et al.\\n(1998)" = 1))
