...
```{r MAB-heatwave1, eval= T, echo = F, out.width = "50%", fig.cap="Marine heatwave events in the Mid-Atlantic occurring in 2019. Color indicates all heatwaves (orange and red) and strongest heatwave (red)."}
